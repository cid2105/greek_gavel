...
LINKEDIN_FIELD_SELECTORS = ['id', 'first-name', 'last-name', 'summary', 'industry', 'honors', 'associations', 'positions', 'skills', 'educations', 'public-profile-url']
...
class LinkedinAuth(ConsumerBasedOAuth):
    ...
    def user_data(self, access_token):
        ...
        try:
            SPECIAL = to_dict(ElementTree.fromstring(raw_xml))
            return SPECIAL
